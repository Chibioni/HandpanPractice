...
{% capture url %}{{ site.github.url }}{% link _pages/start/02/images/01.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [04.リムとDingを速く叩く]({{site.github.url}}{% link _pages/basic/02/01.md %}) をやってみよう
