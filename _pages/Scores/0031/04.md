...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0031/images/04.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [休符移動(高速)01]({{site.github.url}}{% link _pages/Scores/0032/04.md %}) をやってみよう
