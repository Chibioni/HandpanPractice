...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0001/images/03.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [リムを叩く(高速)03]({{site.github.url}}{% link _pages/Scores/0003/03.md %}) をやってみよう
