...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0001/images/01.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [リムを叩く(高速)01]({{site.github.url}}{% link _pages/Scores/0003/01.md %}) をやってみよう
