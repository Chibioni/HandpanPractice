...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0001/images/04.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [リムを叩く(高速)04]({{site.github.url}}{% link _pages/Scores/0003/04.md %}) をやってみよう
