...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0002/images/04.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [リムとDing(高速)04]({{site.github.url}}{% link _pages/Scores/0004/04.md %}) をやってみよう
