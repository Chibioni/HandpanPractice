...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0002/images/01.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [リムとDing(高速)01]({{site.github.url}}{% link _pages/Scores/0004/01.md %}) をやってみよう
