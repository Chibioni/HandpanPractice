...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0002/images/03.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [リムとDing(高速)03]({{site.github.url}}{% link _pages/Scores/0004/03.md %}) をやってみよう
