...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0025/images/03.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [トーンフィールドとDing(高速)03]({{site.github.url}}{% link _pages/Scores/0026/03.md %}) をやってみよう
