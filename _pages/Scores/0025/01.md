...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0025/images/01.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [トーンフィールドとDing(高速)01]({{site.github.url}}{% link _pages/Scores/0026/01.md %}) をやってみよう
