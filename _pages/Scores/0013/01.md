...
{% capture url %}{{ site.github.url }}{% link _pages/Scores/0013/images/01.svg %}{% endcapture %}
...
* 240まで叩いたら、つづけて [リムとトーンフィールド(高速)01]({{site.github.url}}{% link _pages/Scores/0014/01.md %}) をやってみよう