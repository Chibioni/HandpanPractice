...
\relative {
  ...
  \repeat unfold 4 {  b4^\RTopsTop  b'_\LTopsBtm   f^\RThumbTop   e_\LThumbBtm } \break
  \repeat unfold 4 { c'4^\RTopsTop  b,_\LTopsBtm  f'^\RThumbTop   e_\LThumbBtm } \break
  \repeat unfold 4 { c'4^\RTopsTop   b_\LTopsBtm  b,^\RThumbTop   e_\LThumbBtm } \break
  \repeat unfold 4 { c'4^\RTopsTop   b_\LTopsBtm   f^\RThumbTop  b,_\LThumbBtm } \break
